...
<body>
    ...
    <div class="mauto mt45 mb40">
        <h4 class="tac fs36 c9 li38 text-m frumo">EUROPE CAKE</h4>
        <h6 class="tac fs14 c9 li18 text">欧风系列</h6>
    </div>
    ...
    <div class="pro_tab li22 tac mb40 sm-dn">
        ...
        <div class="mauto ptype">
            <a href="List-1.html" tppabs="http://www.tjfozoon.com/Product/10183/List.html" class="dib fs14 c9 text act">全部</a>
             ...
             <li class="wow fadeInUp">
                        <a href="${ctx }/product/show?id=${p.id }&typeid=${p.producttype.id}"  class="db rel">
                            <span class="p-img rel mb50">
                                <img src="/0-finalPrj/img/${p.img1 }" class="imgvt imgvt85" /></span>
                            <div class="p-box tac">
                        ...
                        <span class="db a_label abs fs14 cf s_xp tac">sale</span>
                        <a href="single.jsp" tppabs="http://www.tjfozoon.com/Product/13060/View.html" class="a_cart db abs"></a>
                    </li>
                     </c:forEach>   
        	</ul>
