...
<body>
    ...
    <div class="mauto mt45">
        ...
        <h6 class="tac fs14 c9 li18 text text-b">完成订单</h6>
        ...
        <!-- 支付订单 -->
        <div class="mauto mt10 pl30 pr30 pt20 bgmc">
            <div class="o_pay">
                <!-- 订单付款详情 -->
                <div class="pay_way">
                    <h3 class="li34 c3 fs16 text">订单提交成功</h3>
                </div>
    ...
    <input type="hidden" id="paylink" value="">
    <script>
        $(function () {
            $("#paylink").val("");
            $(".selpay").click(function () {
                $(".selpay").removeClass("act");
                $(this).addClass("act");
                $("#paylink").val($(this).attr("link"));
            });
        });
        function PayLink() {
            var link = $("#paylink").val();
            if (link == "") {
                swal("支付失败", "请选择支付方式！", "warning");
                return;
            }
            else {
    ...
    <div class="footer tac pb45">
        ...
        <div class="footer_share mb35 sm-dn">
            <a href="http://www.tjfozoon.com/Shopping/Success.html?id=12211###" class="qq"></a>
            <a href="http://www.tjfozoon.com/Shopping/Success.html?id=12211###" class="wb"></a>
            <a href="http://www.tjfozoon.com/Shopping/Success.html?id=12211###" class="wx"></a>
        </div>
    ...
    <div class="fixed-right bm-dn">
        <ul>
            <li><a href="http://www.tjfozoon.com/Shopping/Car.html" class="a01"></a><span class="ioc db abs tac" id="t_car_num">0</span></li>
