...
<body>
    ...
    <div class="mauto mt45 mb40">
        <h4 class="tac fs36 c9 li38 text-m frumo">GIFT</h4>
        <h6 class="tac fs14 c9 li18 text">礼盒</h6>
    </div>
    ...
    <div class="pro_tab li22 tac mb40 sm-dn">
        ...
        <div class="mauto ptype">
            <a href="List-3.html" tppabs="http://www.tjfozoon.com/Product/10182/List.html" class="dib fs14 c9 text act">全部</a>
        </div>
    </div>
    
    <div class="product proList">
        <ul class="ma">
            <c:forEach items="${giftlist }" var="p">
                    <li class="wow fadeInUp" data-wow-delay="0s">
                        ...
                        <a href="View-22.html" tppabs="http://www.tjfozoon.com/Product/10589/View.html" class="a_cart db abs"></a>
                    </li>
               </c:forEach>
        </ul>
        <div class="clr"></div>
