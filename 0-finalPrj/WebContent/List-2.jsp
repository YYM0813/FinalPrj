...
<body>
    ...
    <div class="mauto mt45 mb40">
        <h4 class="tac fs36 c9 li38 text-m frumo">AFTERNOON TEA</h4>
        <h6 class="tac fs14 c9 li18 text">下午茶</h6>
    </div>
    ...
    <div class="pro_tab li22 tac mb40 sm-dn">
        ...
        <div class="mauto ptype">
            <a href="List-2.html" tppabs="http://www.tjfozoon.com/Product/10184/List.html" class="dib fs14 c9 text act">全部</a>
    ...
    <div class="product proList">
        <ul class="ma">
            <c:forEach items="${afternoonlist }" var="p">
                    <li class="wow fadeInUp" data-wow-delay="0s">
                        ...
                        <a href="View-14.html" tppabs="http://www.tjfozoon.com/Product/10592/View.html" class="a_cart db abs"></a>
                    </li>
